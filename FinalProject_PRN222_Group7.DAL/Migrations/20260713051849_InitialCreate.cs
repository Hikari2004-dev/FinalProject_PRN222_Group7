        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnswerRelevancy = table.Column<double>(type: "float", nullable: false),
                    ContextPrecision = table.Column<double>(type: "float", nullable: false),
                    ContextRecall = table.Column<double>(type: "float", nullable: false),
                    OverallAccuracy = table.Column<double>(type: "float", nullable: false),
                    ResultsJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RunAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    RunById = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MonthlyAiQueries = table.Column<int>(type: "int", nullable: false),
                    MaxDocuments = table.Column<int>(type: "int", nullable: false),
                    HasQuizGeneration = table.Column<bool>(type: "bit", nullable: false),
                    HasBenchmark = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UploadedByFullName = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RemainingQueries = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    PackageId = table.Column<int>(type: "int", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UploadedByUserEmail = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourceCitations = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Packages",
                columns: new[] { "Id", "Description", "HasBenchmark", "HasQuizGeneration", "IsActive", "MaxDocuments", "MonthlyAiQueries", "Name", "Price", "Tier" },
                values: new object[,]
                {
                    { 1, "Gói miễn phí cho sinh viên", false, false, true, 5, 50, "Basic", 0m, 0 },
                    { 2, "Gói nâng cao cho giảng viên", false, true, true, 50, 500, "Pro", 99000m, 1 },
                    { 3, "Không giới hạn - full features", true, true, true, -1, -1, "Ultra", 299000m, 2 }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_UserPackageId",
                table: "AspNetUsers",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AspNetUsers_UserPackages_UserPackageId",
                table: "AspNetUsers",
                column: "UserPackageId",
